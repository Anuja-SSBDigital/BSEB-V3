<%@ Page Title="" Language="C#" MasterPageFile="~/Agency/MasterPage.master" AutoEventWireup="true" CodeFile="DocCategory.aspx.cs" Inherits="Agency_DocCategory" %>
                ...
                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 px-2">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <asp:DropDownList runat="server" ID="ddl_Status" CssClass="custom-select">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" id="table-1">
                            ...
                            <tbody>
                                <asp:Repeater runat="server" ID="rpt_DocumentTypeData">
                                    <itemtemplate>
                                        <tr>
                                            <td><%# Container.ItemIndex + 1 %></td>
                                            <td><%# Eval("DocCategoryName") %></td>
